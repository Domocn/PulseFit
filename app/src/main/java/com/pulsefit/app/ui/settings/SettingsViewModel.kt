...
class SettingsViewModel @Inject constructor(
    ...
    private val _profile = MutableStateFlow<com.pulsefit.app.domain.model.UserProfile?>(null)
    val profile: StateFlow<com.pulsefit.app.domain.model.UserProfile?> = _profile
